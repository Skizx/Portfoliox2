        ...
        <div className=" md:flex md:items-start xl:mb-10 wrapper">
            ...
            <div className="my-10">
                <h2 className="agbalumo text-4xl md:mb-10 md:text-5xl">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</h2>
                    <p className="mt-4 text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab esse doloremque id minima quidem excepturi atque nisi suscipit ipsam rem quisquam modi itaque ea provident vero totam, dolor molestias commodi!</p>
                    <p className="mt-4 text-lg">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sunt reiciendis cum dolore sequi in laboriosam ducimus molestiae voluptatem nostrum ad tempore veniam, quaerat maxime facere fugit id assumenda placeat soluta!</p>
            </div>
        </div>
        <SkillVignet />
